            ...
            <template x-for="toast in toasts" :key="toast.id">
                <div x-show="toast.show"
                     ...
                     :class="toast.type === 'error'
                         ? 'bg-red-50 dark:bg-red-900/90 border-red-300 dark:border-red-700 text-red-700 dark:text-red-200'
                         : 'bg-green-50 dark:bg-green-900/90 border-green-300 dark:border-green-700 text-green-700 dark:text-green-200'"
                     class="flex items-center gap-3 px-4 py-3 border rounded-lg shadow-lg"
                     style="pointer-events: auto;">
                    <svg x-show="toast.type !== 'error'" class="w-4 h-4 flex-shrink-0 text-green-500 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                    <svg x-show="toast.type === 'error'" class="w-4 h-4 flex-shrink-0 text-red-500 dark:text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span class="flex-1 text-sm font-medium" x-text="toast.message"></span>
                    <button @click="dismiss(toast.id)" class="flex-shrink-0 opacity-50 hover:opacity-100 transition-opacity" style="pointer-events: auto;">
