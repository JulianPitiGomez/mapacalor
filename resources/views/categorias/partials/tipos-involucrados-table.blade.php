<div class="overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            @forelse ($categoria->tiposInvolucrados as $tipo)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button type="button" onclick="editTipoInvolucrado({{ $tipo->id }}, '{{ $tipo->nombre }}', '{{ $tipo->descripcion }}', {{ $tipo->activo ? 'true' : 'false' }})"
                        ...
                        <button type="button" onclick="deleteTipoInvolucrado({{ $tipo->id }})"
            ...
            @empty
                <tr>
                    <td colspan="4" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                        No hay tipos de involucrados registrados.
                    </td>
                </tr>
            @endforelse
        </tbody>
