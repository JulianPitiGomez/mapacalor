            ...
            @forelse ($categoria->subcategorias as $subcategoria)
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button type="button" onclick="editSubcategoria({{ $subcategoria->id }}, '{{ $subcategoria->nombre }}', '{{ $subcategoria->descripcion }}', {{ $subcategoria->activo ? 'true' : 'false' }})"
                        ...
                        <button type="button" onclick="deleteSubcategoria({{ $subcategoria->id }})"
