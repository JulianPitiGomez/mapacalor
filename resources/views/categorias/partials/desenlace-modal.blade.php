<div id="desenlaceModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
    <div class="relative mx-auto p-6 border border-gray-200 dark:border-gray-700 w-full max-w-md shadow-2xl rounded-lg bg-white dark:bg-gray-800">
        <div>
            <h3 class="text-xl font-semibold leading-6 text-gray-900 dark:text-gray-100 mb-6" id="desenlaceModalTitle">
                Agregar Desenlace
            </h3>
            <form id="desenlaceForm">
                <input type="hidden" id="desenlace_id" name="desenlace_id">

                <div class="mb-4">
                    <label for="desenlace_nombre" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Nombre <span class="text-red-500">*</span>
                    </label>
                    <input type="text" id="desenlace_nombre" name="nombre" required
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm">
                </div>

                <div class="mb-4">
                    <label for="desenlace_descripcion" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Descripción
                    </label>
                    <textarea id="desenlace_descripcion" name="descripcion" rows="3"
                ...
                <div class="mb-6">
                    <label class="inline-flex items-center">
                        <input type="checkbox" id="desenlace_activo" name="activo" value="1" checked
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    <button type="button" onclick="closeDesenlaceModal()"
